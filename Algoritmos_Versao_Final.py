# -*- coding: utf-8 -*-
"""
Implementação dos algoritmos de aprendizagem por reforço Q-Learning e Double Q-Learning
no problema de roteamento de veículos capacitados
...
def Biblioteca ():
    ...
    """
    cpvlib = []
    cpvlib.append("Base/A-n32-k5.txt")     # 0 - Ideal é 784
    cpvlib.append("Base/A-n63-k10.txt")    # 1 - Ideal é 1314 
    cpvlib.append("Base/A-n64-k9.txt")     # 2 - Ideal é 1401
    cpvlib.append("Base/B-n31-k5.txt")     # 3 - Ideal é 672
    cpvlib.append("Base/E-n22-k4.txt")     # 4 - Ideal é 375
    cpvlib.append("Base/E-n51-k5.txt")     # 5 - Ideal é 521
    cpvlib.append("Base/P-n16-k8.txt")     # 6 - Ideal é 450
    cpvlib.append("Base/X-n106-k14.txt")   # 7 - Ideal é 26362
...
def ExibeResultados(opcao, ambiente):
    ...
    for Desconto in [0.1, 0.01]: # Taxa de desconto
        ...
        for Lambda in [1, 0.99, 0.975, 0.95, 0.9, 0.8, 0.4, 0]: # Valor de lambda
            ...
            print("Distância: ", round(statistics.mean(valores)), " Desvio: ", round(statistics.pstdev(valores)), " Custo Computacional: ", round(statistics.mean(custoComputacional), 2))
